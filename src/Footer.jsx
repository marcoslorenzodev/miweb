    ...
    return(
        <footer className='footer-container'>
            ...
            <div className='footer-social-media'>
                <a href="https://www.linkedin.com/in/juan-marcos-lorenzo-3260aa211/" target="_blank" rel="noreferrer">
                ...
                <a href="https://www.instagram.com/marc.webp_/" target="_blank" rel="noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48" className='footer-social-media-icon'>
                ...
                <a href="https://github.com/marcoslorenzodev" target="_blank" rel="noreferrer">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48" className='footer-social-media-icon'>
