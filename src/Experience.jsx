    ...
    return(
        <section className='experience-container'>
            <div className='experience-title'>
                ...
                <p>
                    este es un resumen de mi experiencia académica y laboral
                </p>
            </div>
            <div className='experience-cards'>
                <div className='experience-card'>
                    <div>
                        <svg viewBox="0 0 128 128" className='experience-card-icon'>
                    ...
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam commodi assumenda illo. Aut velit sed voluptatum, quisquam illo debitis dolorem autem, veniam nemo rem eos nulla! Iusto atque possimus aliquid!</p>
                </div>
                <div className='experience-card'>
                    <svg viewBox="0 0 128 128" className='experience-card-icon'>
